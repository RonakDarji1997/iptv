  ...
  return (
    <div className="min-h-screen bg-black pb-20">
      ...
      <div>
        {/* Featured Movie Hero */}
        {featuredMovie && (
          <div ref={heroContainerRef} className="relative h-[85vh] sm:h-[90vh] w-full overflow-hidden">
            ...
            {/* Content */}
            <div className={`relative z-10 h-full flex items-end ${isFullscreen ? 'pb-8 pl-8' : 'pb-20 sm:pb-24'}`}>
                      ...
                      <>
                        ...
                        {!isFullscreen && (
                          <button
                            ...
                            className="flex items-center gap-2 px-4 py-3 bg-gray-500/50 text-white rounded-lg hover:bg-gray-500/70 transition-colors backdrop-blur-sm"
                          >
